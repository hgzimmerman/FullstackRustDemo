...
// TODO Deprecate all of this, move this to smaller managed components as dictated by YewRouters.
pub enum Msg {
    HandleForumsResponse(FetchResponse<Vec<ForumData>>),
//    ForumsReady(Vec<ForumData>),
//    ForumsFailed,
    HandleForumResponse(FetchResponse<ForumData>),
//    ForumReady(ForumData),
//    ForumFailed,
    HandleThreadsResponse(FetchResponse<Vec<SelectableMinimalThreadData>>),
//    ThreadsReady(Vec<SelectableMinimalThreadData>),
//    ThreadsFailed,
    HandleThreadResponse(FetchResponse<Thread>),
...
impl Renderable<ForumModel> for ForumModel {
    fn view(&self) -> Html<ForumModel> {
        ...
        fn forum_list_fn(forums: &Vec<ForumData>) -> Html<ForumModel> {
            html! {
                <ul class=("forum-list"),>
        ...
        fn thread_list_fn(threads: &Vec<SelectableMinimalThreadData>) -> Html<ForumModel> {
            html! {
                <ul class=("forum-list"),>
        ...
        fn thread_fn(thread: &ThreadData) -> Html<ForumModel> {
            html! {
                <div>
        ...
        fn new_thread_fn(new_thread: &NewThreadData) -> Html<ForumModel> {
            html! {
                <>
        ...
        fn forum_title(forum_data: &ForumData) -> Html<ForumModel> {
            html! {
                <>
                    {&forum_data.title}
        ...
        fn forums_title(_: &Vec<ForumData>) -> Html<ForumModel> {
            html! {
                <>
                    {"Forums"}
                </>
